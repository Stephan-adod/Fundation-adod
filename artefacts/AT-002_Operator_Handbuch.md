...
npx prettier --write .
npx markdownlint \*_/_.md -c .markdownlint.yml -d || true
...
context: >
GH Actions Workflow 'governance' auf pull_request (main): - setup-node@v20 - run-prettier: npx prettier --check . - run-utf8: node scripts/check-utf8.mjs --root . - validate-tickets: node scripts/validate-ticket.mjs --strict
